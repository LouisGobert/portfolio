...
export const projectsData = [
    ...
    {
        id: 4,
        name: 'Faymonville Production System - Tracking',
        description: 'Developed solutions to track production performance and identify potential improvements, resulting in increased production efficiency.',
        tools: ['MySql', 'C#', 'GitLab', 'InfluxDB', 'Grafana'],
